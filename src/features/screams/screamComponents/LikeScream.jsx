...
export default function LikeButton({scream}) {
  ...
  const { authenticated,currentUser: {uid} } = useSelector((state) => state.auth);
 ...
 function likedScream() {
  ...
  return (
    <>
   {
          ...
          </Segment>):likedScream() || liked ? (
          <div className="">
          <Popup
        content='UnLike This'
        trigger={ 
          <Button as='div' labelPosition='right' onClick={() => {handleUnLikeScream(); setLiked(false)}}>
          <Button color='blue'>
            <Icon name='heart' />
            Like
          </Button>
      ...
      <Popup
        content='Like This'
        trigger={
<Button as='div' labelPosition='right'  onClick={() => {handleLikeScream(); setLiked(true)}}>
